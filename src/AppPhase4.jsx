...
export default function AppPhase4(){
  ...
  const finishSession=()=>{
    ...
    const completed={...summary,gym:'Nordic Wellness',prs:Math.min(3,Math.max(1,sets.filter(s=>s.rpe>=9).length)),calories:Math.round(sets.length*18+summary.volume/95),recovery:sets.length>14?'36–42 timmar':'24–30 timmar'}
