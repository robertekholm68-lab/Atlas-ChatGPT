...
export function AtlasHomeScreen({ profile, core, recommendation, readiness, setPage, now }) {
  ...
  return <div className="atlas-home-page">
    <header className="atlas-home-header"><div className="atlas-home-brand"><span><img className="brand-logo" src="/assets/program-covers/upper-a.svg" alt="ASKR logo" /></span><div><strong>ASKR</strong><small>Performance OS</small></div></div><div className="atlas-header-status"><span>{vm.greeting}</span><button type="button" className="atlas-avatar-button" aria-label="Öppna profil"><UserRound size={19}/></button></div></header>
