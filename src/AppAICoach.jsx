...
export default function AppAICoach() {
  ...
  return <div className="ai-coach-shell">
    <aside className="ai-coach-rail" aria-label="AI Coach navigation">
      <div className="ai-brand"><span><img className="brand-logo" src="/assets/program-covers/upper-a.svg" alt="ASKR logo" /></span><div><strong>ASKR</strong><small>AI COACH</small></div></div>
