...
export const exerciseLibrary = [
  { id:'bench-press', name:'Bench Press', nameSv:'Bänkpress', nameEn:'Bench Press', defaultRestDuration:150, setType:'working', mediaRef:'', equipment:'Barbell', difficulty:'Intermediate', machine:false, type:'Compound', pattern:'Horizontal push', primaryMuscles:['chest'], secondaryMuscles:['front-delts','triceps'], favorite:true, recent:true, custom:false, hero:'BP', thumbnail:'BP', start:'Set shoulders and touch lower chest.', end:'Press up and slightly back.', tips:['Pack shoulders before unracking.','Keep feet planted and bar path consistent.','Stop each set with one clean rep in reserve.'], mistakes:['Flaring elbows too early.','Bouncing the bar.','Losing upper-back tightness.'], records:{weight:'100 kg', reps:'8 reps', volume:'3 680 kg'}, history:[62,74,70,82,88,92], notes:'Use paused first rep on top set.' },
  { id:'seated-row', name:'Seated Row', nameSv:'Sittande rodd', nameEn:'Seated Row', defaultRestDuration:120, setType:'working', mediaRef:'', equipment:'Cable', difficulty:'Beginner', machine:true, type:'Compound', pattern:'Horizontal pull', primaryMuscles:['upper-back','lats'], secondaryMuscles:['biceps'], favorite:true, recent:true, custom:false, hero:'SR', thumbnail:'SR', start:'Reach long with neutral spine.', end:'Pull elbows back and squeeze.', tips:['Lead with elbows.','Pause without leaning back.','Control the stretch.'], mistakes:['Shrugging every rep.','Using momentum.'], records:{weight:'82 kg', reps:'12 reps', volume:'3 120 kg'}, history:[48,55,61,58,66,72], notes:'Seat pin 4.' },
  { id:'shoulder-press', name:'Shoulder Press', nameSv:'Axelpress', nameEn:'Shoulder Press', defaultRestDuration:120, setType:'working', mediaRef:'', equipment:'Dumbbell', difficulty:'Intermediate', machine:false, type:'Compound', pattern:'Vertical push', primaryMuscles:['front-delts'], secondaryMuscles:['triceps'], favorite:false, recent:true, custom:false, hero:'SP', thumbnail:'SP', start:'Dumbbells beside ears.', end:'Finish stacked over shoulders.', tips:['Ribs down.','Press in a slight arc.'], mistakes:['Overarching low back.'], records:{weight:'30 kg', reps:'9 reps', volume:'1 620 kg'}, history:[30,36,42,45,46,48], notes:'Prefer seated when fatigued.' },
  { id:'lat-pulldown', name:'Lat Pulldown', nameSv:'Latsdrag', nameEn:'Lat Pulldown', defaultRestDuration:90, setType:'working', mediaRef:'', equipment:'Cable', difficulty:'Beginner', machine:true, type:'Compound', pattern:'Vertical pull', primaryMuscles:['lats'], secondaryMuscles:['biceps','upper-back'], favorite:false, recent:false, custom:false, hero:'LP', thumbnail:'LP', start:'Arms long, chest tall.', end:'Bar to upper chest.', tips:['Drive elbows to ribs.','Avoid leaning too far back.'], mistakes:['Pulling behind neck.','Half reps.'], records:{weight:'76 kg', reps:'11 reps', volume:'2 420 kg'}, history:[50,56,59,65,68,70], notes:'Medium neutral grip.' },
  { id:'leg-press', name:'Leg Press', nameSv:'Benpress', nameEn:'Leg Press', defaultRestDuration:150, setType:'working', mediaRef:'', equipment:'Machine', difficulty:'Beginner', machine:true, type:'Compound', pattern:'Squat', primaryMuscles:['quads','glutes'], secondaryMuscles:['hamstrings'], favorite:false, recent:false, custom:false, hero:'LG', thumbnail:'LG', start:'Knees tracking over toes.', end:'Press without locking hard.', tips:['Use full comfortable depth.','Keep hips down.'], mistakes:['Short range of motion.'], records:{weight:'220 kg', reps:'12 reps', volume:'6 600 kg'}, history:[80,94,100,112,118,125], notes:'Sled 2, stance medium.' },
  { id:'incline-curl', name:'Incline Curl', nameSv:'Lutande hantelcurl', nameEn:'Incline Curl', defaultRestDuration:75, setType:'working', mediaRef:'', equipment:'Dumbbell', difficulty:'Beginner', machine:false, type:'Isolation', pattern:'Elbow flexion', primaryMuscles:['biceps'], secondaryMuscles:[], favorite:false, recent:false, custom:true, hero:'IC', thumbnail:'IC', start:'Arms behind torso.', end:'Curl without shoulder swing.', tips:['Keep elbows quiet.','Own the lowering.'], mistakes:['Swinging reps.'], records:{weight:'16 kg', reps:'12 reps', volume:'760 kg'}, history:[18,21,22,24,25,27], notes:'Custom: low incline bench.' }
]
...
export const getExerciseMuscles = exercise => ({
  primary: exercise.primaryMuscles || exercise.primary || [],
  secondary: exercise.secondaryMuscles || exercise.secondary || []
})
